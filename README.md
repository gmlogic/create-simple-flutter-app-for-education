...
- `lib/main.dart` with a multiplication practice app for children.
...
- Δείχνει πράξεις προπαίδειας (π.χ. `2 × 3 = ?`).
- Το παιδί γράφει απάντηση και πατάει **Έλεγχος**.
- Αν η απάντηση είναι σωστή, εμφανίζεται επιβράβευση και αυξάνονται οι πόντοι.
- Με **Επόμενη άσκηση** προχωρά στην επόμενη πράξη.
